...
public class ShpShopOP {
    ...
    public ShpShopOP(Long shopId, String shopName, String shopDesc, Long shopOwnerId, String shopIconUrl, String shopMblNo, String shopWxId, String shopAlipayId, String shopQrcodeUrl, String shopSlogen1, String shopSlogen2, String shopType, Long shopMainLottoId, Long shopSubLottoId, Integer shopUserCount, Integer shopTotalOrderCount, Long shopTotalOrderAmt, Integer shopTotalBounsCount, Long shopTotalBounsAmt, BigDecimal shopTotalCommission, String shopAddress, String shopSts, String shopTradSts, Date shopTradBeginTime, Date shopTradEndTime, BigDecimal shopTradRate) {
        this.shopId = shopId;
