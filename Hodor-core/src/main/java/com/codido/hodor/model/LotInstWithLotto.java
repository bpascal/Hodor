...
public class LotInstWithLotto {
    ...
    private LotLotto lotLotto;

    public LotInstWithLotto(Long lottoInstId, Long lottoId, String periodName, Date periodBeginTime, Date periodEndTime, Date periodBonusTime, String periodSts, String periodTags, String periodTagsName, String periodBonusNumber, String periodTotalSell, String periodTotalBonus, String periodTotalBonusDesc) {
    ...
    public LotLotto getLotLotto() {
        return lotLotto;
    }

    public void setLotLotto(LotLotto lotLotto) {
        this.lotLotto = lotLotto;
    }
}