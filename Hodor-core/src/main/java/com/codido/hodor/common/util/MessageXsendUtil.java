...
import com.codido.hodor.common.dto.MessageXSendParaDto;
import com.codido.hodor.common.dto.TimestampRetDto;
...
public class MessageXsendUtil {
    ...
    public static String sendSubMailSms(String projectId,String mblNo, String code) {
         ...
         */
        String appid = "18087";
        String appkey = "cd6b56b9f0342f4e06a394838d42fa50";
        String signtype = "";
