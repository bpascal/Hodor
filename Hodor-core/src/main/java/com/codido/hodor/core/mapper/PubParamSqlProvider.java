...
import com.codido.hodor.core.model.PubParamExample.Criteria;
import com.codido.hodor.core.model.PubParamExample.Criterion;
...
public class PubParamSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getParamId() != null) {
            sql.SET("PARAM_ID = #{record.paramId,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(PubParam record) {
        ...
        sql.WHERE("PARAM_ID = #{paramId,jdbcType=BIGINT}");
